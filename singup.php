    ...
    <div class="container">
        <form id="signup-form" method="POST" action="traitement.php" >
            ...
            <div class="form-group">
               ...
               <input type="text" id="signup-email" name="email" required  placeholder="Entrez votre email ou numéro">
            </div>

            <div class="form-group">
                <label for="signup-password">Mot de passe</label>
                <div class="password-container">
                   <input type="password" id="signup-password" name="password" required placeholder="Entrez votre mot de passe" >
